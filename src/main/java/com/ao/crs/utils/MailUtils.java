...
//        // 您要发送给谁，标题，内容
//        send("1608188128@qq.com", "校园招聘系统", "内容", "smtp", "smtp.qq.com", "1142044719@qq.com", "465", "1142044719", "rhjtbfsdgwhzhhic");
//    }
    public static boolean send(String to, String title, String content, String smtp, String host,
        ...
        try {
            ...
            String nick="";
            try {
                nick=javax.mail.internet.MimeUtility.encodeText("校园招聘系统CRS");
